...
namespace Korbit.LIB.Security
{
    ...
    public class CCryption : IDisposable
    {
        ...
        public static string GetRandomKey()
        {
            ...
            int _offset = _random.Next(CryptoString.GetLowerBound(0), CryptoString.GetUpperBound(0));
        ...
        {
            int _offset = KeyVersions.IndexOf(SelectedKey);
		...
		public byte[] ComputeHash(string p_plain_text, string p_hashAlgorithm = "SHA256", byte[] p_saltBytes = null)
        {
            ...
            if (p_saltBytes == null)
            {
                ...
                var _random = new Random();
                int _saltSize = _random.Next(_minSaltSize, _maxSaltSize);

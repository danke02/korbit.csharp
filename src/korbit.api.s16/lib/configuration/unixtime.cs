...
namespace Korbit.LIB.Configuration
{
    ...
    public class UnixTime
    {
        ...
        /// <returns></returns>
        public static string ToUtcTimeString(DateTime utctime)
        {
            return utctime.ToUniversalTime().ToDateTimeZoneString();
        }
        ...
        public static DateTime GetFirstDayOfMonth(int p_monthOfTarget)
        {
            ...
            // create a datetime variable set to the passed in date 
            DateTime _firstDay = new DateTime(UnixTime.UtcNow.Year, p_monthOfTarget, 1).ToUniversalTime();
        ...
        public static DateTime GetLastDayOfMonth(int p_monthOfTarget)
        {
            ...
            // create a datetime variable set to the passed in date 
            DateTime _lastDay = new DateTime(UnixTime.UtcNow.Year, p_monthOfTarget, 1).ToUniversalTime();

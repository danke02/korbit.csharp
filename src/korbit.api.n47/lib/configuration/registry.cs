...
namespace Korbit.LIB.Configuration
{
    /// <summary>
    /// 
    /// </summary>
    public class CRegistry
    {
        ...
        public int Get46or461FromRegistry()
        {
            ...
            if (_ndpKey != null)
                _result = Convert.ToInt32(_ndpKey.GetValue("Release"));
        ...
        public string GetFrameworkRoot()
        {
            ...
            return _install_root != null ? _install_root.ToString() : String.Empty;
        }
        ...
        public bool CheckNetFrameworkInstalled(int releaseKey = 393295)
        {
            ...
            */
            ...
            {
                var _release_key = _ndpkey.GetValue("Release");
                if (_release_key != null && Convert.ToInt32(_release_key) >= releaseKey)
                    _result = true;
            }
        ...
        public bool IsProgramInstalled(string displayName)
        {
            ...
            string _uninstall_key = @"SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall";
        ...
        public bool IsRedistributableInstalled(bool is64bit)
        {
            ...
            string _uninstall_key = @"SOFTWARE\Microsoft\VisualStudio\14.0\VC\Runtimes\";
            if (is64bit == true)
                _uninstall_key += @"x64";
            else
                _uninstall_key += @"x86";
            ...
            if (_regloc != null)
            {
                ...
                if (_regkey != null)
                {
                    var _value = _regkey.GetValue("Installed");
                    if (_value != null && _value.ToString() == "1")
                        _result = true;
                }
            }
